...
import { MYSTERY_BOX_ADDRESS, VRFCOORDINATORMOCK_ADDRESS_LOCALHOST, CHAINLINK_WAIT_TIME_MINUTES } from "./constants";
...
function App() {
  ...
  async function getUserDerpiesHandler() {
    ...
    try {
      if (typeof window.ethereum !== "undefined") {
        ...
        const contract = new ethers.Contract(MYSTERY_BOX_ADDRESS, Derpies.abi, provider);
  ...
  async function mintDerpie() {
    ...
    const derpiesContract = new ethers.Contract(MYSTERY_BOX_ADDRESS, Derpies.abi, signer);
