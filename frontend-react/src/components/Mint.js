          ...
          <div class="tile is-parent">
            <div class="tile is-child is-fluid is-max-desktop box">
             ...
             {isConnected && (
               <div>
                <p><img>{Logo}</img></p>
                <button className={`button mt-4 mb-4 ${metamaskWaitingOnUser ? "is-loading" : ""}`} disabled={mintingInProgress} onClick={mintNFTHandler}>
                   Mint a {NFT_NAME}
                </button>
               </div>
             )}
             ...
             <div className="is-flex is-flex-direction-column is-justify-content-center is-align-items-center mt-4">
               {isNewlyMinted && (
                 <>
                   ...
                   <div className="is-flex is-flex-direction-column is-justify-content-center is-align-items-center mt-4">
                     {isNewlyMinted && <UserNFT nftDetails={mintedNFTDetails} />}
                   </div>
